...
@interface DataSource16 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource16
+ (DataSource16 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource16 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource16 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData16"];
