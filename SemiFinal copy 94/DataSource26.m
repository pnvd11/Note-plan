...
@interface DataSource26 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource26
+ (DataSource26 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource26 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource26 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData26"];
