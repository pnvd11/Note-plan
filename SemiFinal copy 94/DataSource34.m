...
@interface DataSource34 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource34
+ (DataSource34 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource34 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource34 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData34"];
