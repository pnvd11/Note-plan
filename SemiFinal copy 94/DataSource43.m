...
@interface DataSource43 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource43
+ (DataSource43 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource43 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource43 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData43"];
