...
@interface DataSource11 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource11
+ (DataSource11 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource11 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource11 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData11"];
