...
@interface DataSource32 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource32
+ (DataSource32 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource32 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource32 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData32"];
