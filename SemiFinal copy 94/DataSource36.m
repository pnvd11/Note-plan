...
@interface DataSource36 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource36
+ (DataSource36 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource36 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource36 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData36"];
