...
@interface DataSource21 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource21
+ (DataSource21 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource21 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource21 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData21"];
