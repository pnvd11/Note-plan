...
@interface DataSource24 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource24
+ (DataSource24 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource24 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource24 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData24"];
