...
@interface DataSource46 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource46
+ (DataSource46 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource46 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource46 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData46"];
