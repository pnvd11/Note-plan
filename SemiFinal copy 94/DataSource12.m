...
@interface DataSource12 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource12
+ (DataSource12 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource12 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource12 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData12"];
