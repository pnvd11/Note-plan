...
@interface DataSource17 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource17
+ (DataSource17 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource17 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource17 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData17"];
