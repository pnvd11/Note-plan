...
@interface DataSource19 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource19
+ (DataSource19 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource19 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource19 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData19"];
