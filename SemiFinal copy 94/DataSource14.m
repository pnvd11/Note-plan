...
@interface DataSource14 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource14
+ (DataSource14 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource14 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource14 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData14"];
