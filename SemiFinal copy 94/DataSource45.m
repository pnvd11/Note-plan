...
@interface DataSource45 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource45
+ (DataSource45 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource45 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource45 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData145"];
...
- (void)save
{
    NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData45"];
