...
@interface DataSource25 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource25
+ (DataSource25 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource25 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource25 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData25"];
