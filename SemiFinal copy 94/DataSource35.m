...
@interface DataSource35 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource35
+ (DataSource35 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource35 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource35 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData35"];
