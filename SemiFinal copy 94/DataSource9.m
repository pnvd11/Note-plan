...
@interface DataSource9 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource9
+ (DataSource9 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource9 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource9 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData9"];
