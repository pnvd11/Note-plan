...
@interface DataSource30 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource30
+ (DataSource30 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource30 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource30 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData30"];
