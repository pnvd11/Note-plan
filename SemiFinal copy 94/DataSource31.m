...
@interface DataSource31 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource31
+ (DataSource31 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource31 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource31 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData31"];
