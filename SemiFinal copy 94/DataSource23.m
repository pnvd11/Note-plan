...
@interface DataSource23 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource23
+ (DataSource23 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource23 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource23 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData23"];
