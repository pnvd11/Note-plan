...
@interface DataSource37 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource37
+ (DataSource37 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource37 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource37 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData37"];
