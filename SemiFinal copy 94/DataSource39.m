...
@interface DataSource39 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource39
+ (DataSource39 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource39 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource39 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData39"];
