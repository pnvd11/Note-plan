...
@interface DataSource15 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource15
+ (DataSource15 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource15 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource15 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData15"];
