...
@interface DataSource44 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource44
+ (DataSource44 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource44 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource44 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData44"];
