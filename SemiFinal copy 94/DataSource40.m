...
@interface DataSource40 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource40
+ (DataSource40 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource40 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource40 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData40"];
