...
//  xXx
//
//  Created by kuku kay on 11/3/13.
...
+ (DataSource1 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource1 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource1 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData1"];
