...
@interface DataSource18 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource18
+ (DataSource18 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource18 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource18 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData18"];
