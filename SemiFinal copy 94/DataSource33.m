...
@interface DataSource33 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource33
+ (DataSource33 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource33 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource33 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData33"];
