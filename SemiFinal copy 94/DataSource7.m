...
@interface DataSource7 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource7
+ (DataSource7 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource7 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource7 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData7"];
