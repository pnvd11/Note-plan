...
@interface DataSource41 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource41
+ (DataSource41 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource41 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource41 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData41"];
