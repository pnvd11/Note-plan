...
@interface DataSource48 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource48
+ (DataSource48 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource48 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource48 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData48"];
