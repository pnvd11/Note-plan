...
@interface DataSource10 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource10
+ (DataSource10 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource10 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource10 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData10"];
