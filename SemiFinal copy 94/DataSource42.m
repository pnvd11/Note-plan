...
@interface DataSource42 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource42
+ (DataSource42 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource42 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource42 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData42"];
