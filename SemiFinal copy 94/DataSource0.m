...
@interface DataSource0 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end

@implementation DataSource0

+ (DataSource0 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource0 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource0 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData0"];
