...
@interface DataSource28 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource28
+ (DataSource28 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource28 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource28 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData28"];
