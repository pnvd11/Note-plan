...
@interface DataSource38 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource38
+ (DataSource38 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource38 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource38 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData38"];
