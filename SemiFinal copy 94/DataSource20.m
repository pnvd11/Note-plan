...
@interface DataSource20 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource20
+ (DataSource20 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource20 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource20 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData20"];
