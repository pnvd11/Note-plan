...
@interface DataSource47 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource47
+ (DataSource47 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource47 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource47 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData47"];
