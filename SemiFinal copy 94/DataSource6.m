...
@interface DataSource6 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource6
+ (DataSource6 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource6 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource6 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData6"];
