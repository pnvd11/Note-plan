...
@interface DataSource22 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource22
+ (DataSource22 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource22 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource22 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData22"];
