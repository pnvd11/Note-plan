...
@interface DataSource5 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource5
+ (DataSource5 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource5 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource5 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData5"];
