...
@interface DataSource27 ()

@property (nonatomic, strong) NSMutableArray *dataArray;

@end
@implementation DataSource27
+ (DataSource27 *)sharedInstance
{
    static dispatch_once_t  onceToken;
    static DataSource27 * sSharedInstance;
    
    dispatch_once(&onceToken, ^{
        sSharedInstance = [[DataSource27 alloc] init];
    });
...
- (id)init
{
    ...
    if (self != nil)
    {
        NSURL *dataFileURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SavedData27"];
